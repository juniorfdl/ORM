...
type
  ...
  public
    ...
    [Column('lookup_name', ftString, 60)]
    [JoinColumn('lookup_id', 'lookup', 'lookup_id', 'lookup_name', InnerJoin, 'lookup_name')]
    [Dictionary('Nome do Cliente')]
    property lookup_name: string read flookup_name write flookup_name;
  end;
