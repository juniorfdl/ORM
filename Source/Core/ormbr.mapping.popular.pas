    ...
    begin
      ...
      begin
        ...
        begin
          ...
          if Length(Association(LAssociation).ColumnsSelectRef) > 0 then
          begin
            SetLength(LColumns, Length(Association(LAssociation).ColumnsSelectRef));
            for LFor := 0 to High(Association(LAssociation).ColumnsSelectRef) do
              LColumns[LFor] := Association(LAssociation).ColumnsSelectRef[LFor];
          end;
