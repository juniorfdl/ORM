...
begin
  ...
  begin
    ...
    begin
      for LColumn in AAssociation.ColumnsNameRef do
      begin
        if not AAssociation.ColumnsSelectRef.Contains(LColumn) then
          LCriteria.Column(LTable.Name + '.' + LColumn);
      end;
      for LColumn in AAssociation.ColumnsSelectRef do
        LCriteria.Column(LTable.Name + '.' + LColumn);
    end
    else
      LCriteria.All;
