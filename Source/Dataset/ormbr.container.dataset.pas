...
type
  ...
  public
    ...
    procedure OpenWhere(AWhere: string; AOrderBy: string = '');
    procedure Insert;
    procedure Append;
    procedure Post;
    procedure Edit;
...
procedure TContainerDataSet<M>.Lazy(AOwner: M);
begin
  FDataSetAdapter.Lazy(AOwner);
end;
...
procedure TContainerDataSet<M>.OpenWhere(AWhere, AOrderBy: string);
begin
