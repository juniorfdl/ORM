...
procedure TClientDataSetAdapter<M>.DoBeforeDelete(DataSet: TDataSet);
begin
...
procedure TClientDataSetAdapter<M>.OpenAssociation(const ASQL: string);
var
...
begin
  ...
  try
    ...
    EnableDataSetEvents;
    /// <summary>
    /// Erro interno do FireDAC se o método First se o dataset estiver vazio
    /// </summary>
